...
import {loginViaPhoneConfirmFormSchema, loginViaPhoneFormSchema} from "../../../../utils/validations/login";
import TextField from "../../../UI/Forms/TextField/TextField";
import Button from "../../../UI/Forms/Button/Button";
import {AuthApi} from "../../../../utils/api";
import {AuthWithPhoneConfirmDto, AuthWithPhoneDto} from "../../../../utils/api/types";
    ...
    <>
      ...
      <div className="flex flex-col w-full border-opacity-50">
        {! confirmMode
          ...
          :
            <form noValidate="" action="" onSubmit={confirmForm.handleSubmit(onSubmitConfirm)}>
              <div className="flex flex-col gap-y-6">
                <div>
                  <TextField
                   label="Телефон"
          ...
          <p className="p-2 text-sm text-center">
            <Button type="button" variant="primary" link onClick={() => emailLogin()}>Войти по почте</Button>
          </p>
